...
function ListBox({animes, handleSelectedAnime}){
  ...
  return (
    <div className="box">
          ...
          {isOpen1 && (
            <ListAnime animes={animes} handleSelectedAnime={handleSelectedAnime} />
          )}
        </div>
  )
}

function ListAnime({animes, handleSelectedAnime}){
  return (
